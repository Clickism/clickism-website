...
export default function Hero() {
  return (
    <div
      className="relative flex flex-col items-center justify-center min-h-125 bg-[url(/hero-bg.png)] bg-no-repeat bg-cover bg-bottom rounded-2xl border border-white/20">
