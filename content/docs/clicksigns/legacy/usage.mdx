...
To craft a _Road Sign_, put **8 iron ingots** around **any sign**:
...
- **Make sure to click CONFIRM once you're done.** _Your changes won't be saved if you don't._
- Click **Change Template** to browse through all the various templates.

## Changing The Road Sign Template

- After you click _Change Template_, you will be welcomed by this screen:
...
- The templates are displayed in the format: _"Width x Height : Pack : Name : (Details)"_
