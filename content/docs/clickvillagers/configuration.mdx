...
ClickVillagers uses the YAML format for configuration.
...
<Steps>
  <Step>
    ### Fabric
    If you are using the mod on a **client**: `.minecraft/config/ClickVillagers/config.yml`
  ...
  <Step>
    ### Paper / Spigot
    Found at `.../plugins/ClickVillagers/config.yml`
  </Step>
</Steps>
