...
If you haven't read the [Configuration](configuration) section, I recommend you do so first
...
_The `?hostile` is a tag, and targets all hostile mobs.
We will look into tags in closer detail in the [Tags](tags.md) section._
...
For _Fabric_, if there is no namespace given, it will default to `minecraft:`.
